...
csw <- stop_words
# no idea: csw <- csw($(csw$word=="against"))
```
...
```{r}
# mine didn't look the same as below
...
```{r}
# why are stop words here? - this file still has stop words; not sure why we didn't use one of the other files without
